	...
	render() {
		return (
			<div className="nav" id='nav'>
				...
				<li className="menu_li nav_author nav_author_abstract"><Link to='/author/abstract'>抽象派</Link></li>
				<li className="menu_li nav_author nav_author_cityscape"><Link to='/author/cityscape'>城市风</Link></li>
			</div>
		);
	}
}
